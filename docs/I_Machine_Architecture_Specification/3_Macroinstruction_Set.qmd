...
OTP-FIXNUM `dtp-small-ratio` OTP-SINGLE-FLOAT `dtp-double-float` DTP\~BIGNUM `dtp-big-ratio` DBTP-COMPLEX OTP-SPARE-NUMBER OTP-INSTANCE OTP-LIST-INSTANCE DTP-ARRAY=INSTANCE OYP-STRING-INSTANCE OTP-NIL
...
OTP-NULL a DTP---MONITOR-FORWARD 1 `dtp-header-p` 2 `dtp-header-i` 3 `dtp-one-q-forward` 5 `dtp-header-forward` 6 DTP-ELEMENT\~FORWARD 7 DTP-GC\~FORWARD 45
