...
#[derive(Clone, Debug)]
pub struct XParams {
    pub xp_host_name: String,
    pub xp_host_address: u64,
    pub xp_display: u32,
    pub xp_screen: u32,
    pub xp_initial_state: u32,
    pub xp_geometry: String,
    pub xp_foreground_color: String,
    pub xp_background_color: String,
    pub xp_border_color: String,
    pub xp_border_width: u32,
}
    ...
    fn default() -> Self {
        ...
        let config = Self {
            ...
            cold_load_xparams: XParams {
                xp_host_name: "".to_string(),
                xp_host_address: 0,
                xp_display: 0,
                xp_screen: 0,
                xp_initial_state: 0,
                xp_geometry: "".to_string(),
                xp_foreground_color: "".to_string(),
                xp_background_color: "".to_string(),
                xp_border_color: "".to_string(),
                xp_border_width: 0,
            },
